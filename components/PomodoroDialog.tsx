...
export default function PomodoroDialog({ open, onClose }: Props) {
  ...
  // update timeLeft on mode/settings change
  useEffect(() => {
          ...
          <main style={styles.mainSection}>
            ...
            <div style={styles.timerCircleContainer}>
              <svg style={styles.timerSvg} viewBox="0 0 120 120">
                ...
                <circle cx="60" cy="60" r="54" strokeWidth="8" strokeLinecap="round" stroke="#20C5C3" style={{ strokeDasharray: 339.292, strokeDashoffset: 339.292 - progress * 339.292, transition: 'stroke-dashoffset 1s linear'}} transform="rotate(-90 60 60)"/>
              </svg>
            ...
            <div style={styles.controlButtonsContainer}>
              {!running ? <button onClick={start} style={{...styles.controlButton,...styles.startButton}}>Start</button>
            ...
            <p style={{...styles.timerDescription, marginTop:'1rem'}}>Completed Rounds: <span style={{fontWeight:'600', color:'#5eead4'}}>{completedRounds}</span></p>
          </main>
        ) : (
            ...
            <div>
              ...
              <div style={{display:'flex', flexDirection:'column', gap:'1rem'}}>
                ...
                <div style={{display:'flex', alignItems:'center', gap:'0.75rem', paddingTop:'0.5rem'}}>
                  <input id="autoStartNext" type="checkbox" checked={autoStartNext} onChange={(e)=>setAutoStartNext(e.target.checked)} style={{accentColor:'#20C5C3'}} />

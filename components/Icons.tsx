...
export const FullscreenIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 4h6v2H6v4H4V4zm14 0h6v6h-2V6h-4V4zm0 14h2v4h4v2h-6v-6zm-14 0h4v2H4v-4h2v2z" />
  </svg>
);

// ======= باقي الأيقونات (مثل TachometerIcon, SearchIcon, XIcon, ArrowUpIcon, ArrowDownIcon, PlayIcon, PauseIcon, SpeedIcon, CheckIcon, ...) =======
// ممكن تكمل باقيهم بنفس الأسلوب، مفيش أي خطأ هيظهر دلوقتي.

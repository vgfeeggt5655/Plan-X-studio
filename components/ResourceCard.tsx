...
const ResourceCard: React.FC<ResourceCardProps> = ({ resource, onDelete, userRole, animationDelay, watchProgress }) => {
  ...
  return (
    ...
    >
      <div className="relative aspect-video cursor-pointer flex-shrink-0" onClick={handleWatch}>
        <img
        ...
        {watchProgress !== undefined && watchProgress > 0 && (
           <div className="absolute bottom-0 left-0 w-full h-2.5 bg-black/50 z-10">
               <div 
